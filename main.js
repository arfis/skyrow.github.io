...
var PoolComponent = /** @class */ (function () {
    ...
    PoolComponent.prototype.vote = function () {
        var _this = this;
        this._poolService.registerVote(this.optionResult, this.pool.id).subscribe(function (result) {
...
var CreatePoolProcessPageComponent = /** @class */ (function () {
    ...
    CreatePoolProcessPageComponent.prototype.createPool = function () {
        ...
        if (this.hasQuestions && this.poolName.length > 0) {
            ...
            }, function (error) { alert('There was some issue with writing data into blockchain. Wait a couple of minutes and try again.'); _this.error = error; });
        }
    };
...
var PoolsService = /** @class */ (function () {
    ...
    PoolsService.prototype.registerVote = function (results, poolId) {
        ...
        return this._nosService.invoke(_Methods__WEBPACK_IMPORTED_MODULE_2__["Methods"].scriptHash, _Methods__WEBPACK_IMPORTED_MODULE_2__["Methods"].registerVote, [this._nosService.address, 'DATA'].concat(result));
    };
